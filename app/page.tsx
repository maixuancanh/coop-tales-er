...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#fbf4ff] text-[#1d1423]">
      <section className="mx-auto grid min-h-screen max-w-7xl grid-cols-1 gap-6 px-5 py-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
        <div className="flex flex-col justify-between rounded-xl bg-[#24142f] p-6 text-white">
          <nav className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Image src="/brand-logo.png" alt="Coop Tales ER logo" width={48} height={48} className="h-12 w-12 rounded-lg object-cover" priority />
        ...
        <div className="rounded-xl border border-purple-950/10 bg-white p-5 shadow-xl">
          ...
          <div className="grid gap-5 py-5">
            ...
            <div className="rounded-lg border border-purple-950/10 bg-purple-50 p-4"><p className="text-xs uppercase tracking-[0.18em] text-purple-950/50">Contribution hash</p><p className="mt-2 break-all font-mono text-xs text-purple-800">{contributionHash}</p></div>
